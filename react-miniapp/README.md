...
- Что я ожидал
- Что произошло
- Почему это произошло (бралось одно и тоже значение на рендер)
...
- Что я ожидал
- Что произошло
- Почему это произошло (tick в зависимостях хука тригерил useEffect что и делало бесконечным useEffect)
- Где это важно в реальных проектах
...
- Что я ожидал
- Что произошло
- Почему это произошло (потому что разрабу в ТЗ явно не описали работу поиска)
- Где это важно в реальных проектах
